...
pipe = FluxPipeline.from_pretrained("/data/pretrained/Flux/black-forest-labs/FLUX.1-dev", torch_dtype=torch.bfloat16)
...
def eval_flux1_dev(image, prompt, edit=False):
    ...
    if edit:
        ...
        pipe = FluxKontextPipeline.from_pretrained("/data/pretrained/Flux1_Kontext_dev/", torch_dtype=torch.bfloat16)
        pipe.enable_model_cpu_offload() #save some VRAM by offloading the model to CPU. Remove this if you have enough GPU power
